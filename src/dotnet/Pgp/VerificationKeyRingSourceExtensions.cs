...
{
    public static PgpVerificationResult Verify<T>(this T verificationKeyRingSource, ReadOnlySpan<byte> message, PgpEncoding encoding = default)
    ...
    public static PgpVerificationResult Verify<T>(this T verificationKeyRingSource, Stream messageStream, PgpEncoding encoding = default)
        where T : IVerificationKeyRingSource
    {
